...
- WebSocket-уведомления в реальном времени о создании/изменении/удалении задач
- Delta-sync эндпоинт (`GET /tasks/sync?since=`) для восстановления пропущенных изменений после разрыва соединения
- Soft delete вместо физического удаления — обеспечивает корректную синхронизацию
